@ECHO OFF
SET DXC="D:\EpigGames\UE_5.7\Engine\Binaries\ThirdParty\ShaderConductor\Win64\dxc.exe"
IF NOT EXIST %DXC% (
	ECHO Couldn't find dxc.exe under "D:\EpigGames\UE_5.7\Engine\Binaries\ThirdParty\ShaderConductor\Win64"
	GOTO :END
)
